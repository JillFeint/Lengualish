...
export default function FooterRedes() {
  console.log("Los compas del codigo")
  return (
    <div className='footerRedes'>
      <div className="footerRedesEspacio1"></div>
      <div className="footerWhatsapp">
      <h3>Contantanos por</h3>
      <button class="btnRedesWhatsapp">
      ...
      <button class="btnRedesInstagram">
        <span class="svgRedesInstagram">
      ...
      <div className="footerYoutube">
        <h3>Mira nuestro contenido <br/> en youtube</h3>
      <button class="btnRedesYoutube">
        <span class="svgRedesYoutube">
        <svg
          viewBox="0 0 576 512"
          fill="white"
          height="1.6em"
      ...
      <div className="footerRedesEspacio2"></div>
      {/* <div className="footerMade">
        <h5> Hecho con ❤️ por los Compas del codigo | &copy;2024</h5>
      </div> */}
    </div>
  )
}